...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            #households .household .individual {
                margin-left: 20px;
            }
            ...
            #allHouseholdsTable tr.community {
                background-color: #5325be;
                color: #fff;
            }

            #allHouseholdsTable tr.approval {
                background-color: #25be32;
                color: #000;
            }

            #allHouseholdsTable tr.single-man {
                background-color: #5c7dca;
                color: #fff;
            }

            #allHouseholdsTable tr.single-woman {
