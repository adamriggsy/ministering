  ...
  var functions = {
    ...
    'commentCreateSuccess': function commentCreateSuccess(response) {
      if (response.saved) {
        ...
        _comments_js__WEBPACK_IMPORTED_MODULE_0__.commentsHelper.functions.buildComments(_comments_js__WEBPACK_IMPORTED_MODULE_0__.commentsHelper.functions.getDataAttr('commentCardTemplate'), activeContainer.find(css.household.comments), response.comments, 'No comments yet.');
    ...
    'replaceHouseholdComments': function replaceHouseholdComments(hComments) {
      var wantedHousehold = _.find(data.households, function (household) {
