  ...
  var functions = {
    ...
    'commentCreateSuccess': function commentCreateSuccess(response) {
      if (response.saved) {
        ...
        _comments_js__WEBPACK_IMPORTED_MODULE_0__.commentsHelper.functions.buildComments(functions.getActiveContainerById(functions.getDataAttr('currentMinisterId')), response.comments, 'No feedback provided.');
